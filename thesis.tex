...
\includeonly{./tex/titlepage,./tex/abstract,./tex/acknowledgements,\ignore{}./tex/paper,./tex/performance,\ignore{}./tex/replacement,./tex/appendixCAR,./tex/appendixBufferPoolLog,./tex/tu_logo,./tex/command_definitions_early,./tex/command_definitions_late}
...
\begin{document}
	...
	\include{./tex/performance}

	\include{./tex/replacement}
		
	\appendix
	
	\include{./tex/appendixCAR}
	
	\include{./tex/appendixBufferPoolLog}
